namespace ContosoUniversity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SchoolContext>
    {
        ...
        protected override void Seed(SchoolContext context)
        {
            ...
            {
                new Instructor { FirstMidName = "Kim", LastName = "Abercrombie", HireDate = DateTime.Parse("2010-03-11") },
                new Instructor { FirstMidName = "Shannon", LastName = "Beiste", HireDate = DateTime.Parse("2010-03-11") },
            ...
            var departments = new List<Department>
            {
                ...
                new Department { Name = "PhysEd", Budget = 150000, StartDate = DateTime.Parse("2007-09-01"),
                InstructorID = instructors.Single( i => i.LastName == "Beiste").ID },
            ...
            var courses = new List<Course>
            {
                ...
                DepartmentID = departments.Single( s => s.Name == "PhysEd").DepartmentID,
                Instructors = new List<Instructor>()
                },
